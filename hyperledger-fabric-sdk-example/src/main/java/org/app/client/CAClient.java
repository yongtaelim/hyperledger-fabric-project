...
//		System.out.println("Private Key: " + DatatypeConverter.printHexBinary(pair.getPrivate().getEncoded()).toLowerCase());
...
//		Util.writeUserContext(adminContext);
	...
	public UserContext enrollUser(UserContext user, String secret) throws Exception {
		...
		Enrollment enrollment = instance.enroll(user.getName(), secret, enrollmentRequest);
